...
class UserStoryGenerator:
    ...
    ACTION_VERBS = {
        "upload", "download", "preview", "view", "print", "delete", "create",
        "update", "edit", "modify", "list", "search", "find", "approve",
        "reject", "submit", "save", "validate", "check", "notify", "record",
        "log", "delegate", "assign", "track", "monitor", "filter", "sort",
        "export", "import", "share", "send", "receive", "archive", "restore",
        "cancel", "suspend", "resume", "activate", "deactivate", "enable", "disable",
        "grant", "revoke", "add", "remove", "attach", "detach", "link", "unlink",
        "merge", "split", "compare", "analyze", "calculate", "generate", "schedule",
        "book", "reserve", "release", "transfer", "move", "copy", "clone", "duplicate",
    }

    # Words that should NOT be used as roles
    STOP_ROLES = {
        "only", "also", "even", "just", "all", "each", "every", "some", "any",
        "the", "a", "an", "this", "that", "these", "those", "my", "your", "our",
        "be", "have", "do", "get", "make", "take", "go", "come", "see", "know",
        "think", "say", "look", "want", "need", "use", "work", "give", "tell",
        "ask", "try", "feel", "become", "leave", "put", "mean", "keep", "let",
        ...
        "add", "spend", "grow", "open", "walk", "offer", "remember", "love", "consider",
        "appear", "buy", "wait", "serve", "die", "send", "expect", "build", "stay",
        "fall", "cut", "reach", "kill", "remain", "suggest", "raise", "pass", "sell",
        "require", "report", "decide", "pull", "upload", "download", "preview", "print",
        "delete", "edit", "update", "list", "search", "find", "approve", "reject",
        "submit", "save", "validate", "check", "notify", "record", "log", "delegate",
    }
    ...
    def _extract_action(self, feature: str) -> str:
        ...
        prefixes = (
            "be able to ", "provide ", "support ", "expose ", "record ",
            "enforce ", "maintain ", "generate ", "send ", "validate ",
            "check ", "have ", "use ", "get ", "make ", "take ",
        )
        ...
        suffixes = (
            " in the system", " from the system", " to the system",
            " on the system", " via the system", " through the system",
            " as needed", " if needed", " when needed", " as required",
            " for the business", " for business", " for the organization",
        )
    ...
    def _infer_value(self, action: str, domain: DomainAnalysis) -> str:
        ...
        value_patterns = [
            ...
            ("preview", "I can verify content without downloading or opening in another application"),
            ...
            ("reject", "invalid requests are blocked and returned for correction with clear feedback"),
            ...
            ("check", "conditions or status can be verified before proceeding with dependent actions"),
            ("notify", "stakeholders are informed of important events without manual communication"),
            ("record", "a complete history is maintained for compliance, audit, and troubleshooting"),
            ("log", "audit trail is available for accountability and security investigation"),
            ("delegate", "workflows continue even when primary approvers are unavailable or on leave"),
            ...
            ("archive", "old records are preserved but removed from active workflows to reduce clutter"),
