...
class RequirementSpec(BaseModel):
    ...
    business_objects: List[str] = Field(default_factory=list, description="Business entities/objects")
    features: List[str] = Field(default_factory=list, description="Functional features")
    constraints: List[str] = Field(default_factory=list, description="Constraints, permissions, audit requirements")
...
class AcceptanceCriteriaGroup(BaseModel):
    ...
    criteria: List[AcceptanceCriterion] = Field(default_factory=list, description="List of criteria")
...
class ApiSpec(BaseModel):
    ...
    permission_required: Optional[str] = Field(default=None, description="Required permission")
    ...
    error_codes: List[Union[str, int]] = Field(default_factory=list, description="Possible error codes")
...
class TestCase(BaseModel):
    ...
    related_ac: List[str] = Field(default_factory=list, description="Related acceptance criteria IDs")
...
class Task(BaseModel):
    ...
    estimated_effort: str = Field(default="medium", description="Effort estimate: small, medium, large")
...
class AiCodingTask(BaseModel):
    ...
    testing_requirements: List[str] = Field(default_factory=list, description="Testing expectations")
    agent_instructions: List[str] = Field(default_factory=list, description="Instructions for the AI coding agent")
    files_to_modify: List[str] = Field(default_factory=list, description="Files to modify")
